...
<head>
  ...
  <title>KobisonPOS - Inventory Details</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>
        <a href="#" class="btn-sm btn-dark" id="view_inventory_category_details">Category Details</a>
  
        <a href="#" class="btn-sm btn-info bg-yellowish" id="view_purchases_by_date">Purchase Details</a>
        &nbsp;
        <!-- <a href="#" class="btn-sm btn-danger bg-redish" id="view_inventory_bar_graph">View Bar Graph</a> -->
        </p>
        
        <!-- DataTables Example -->
        <div id="inventory_details_content">
