...
<head>
  ...
  <title>KobisonPOS - Notifications</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- DataTables Example -->
        <div id="view_notification_content">
        <!-- List of products here -->
        <div class="card-mb-3">
        <div class="card-header bg-bluish" style="color:#fff;">
        <h6><i class="fa fa-bell">&nbsp;</i>Notification Messages
        </h6></div>
        <div class="card-body">
        <div class="table-responsive">
        <table class="table" id="view_notification_table" width="100%" cellspacing="0">
        <thead>
        <tr>
        <th>Date</th>
        <th>Message</th>
